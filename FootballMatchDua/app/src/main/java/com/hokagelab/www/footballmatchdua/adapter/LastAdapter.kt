...
class LastAdapter(
    private val item: MutableList<LastEvent>,
    private val listener: (LastEvent) -> Unit
    ) : RecyclerView.Adapter<com.hokagelab.www.footballmatchdua.adapter.LastAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(view: View) :RecyclerView.ViewHolder(view){
        ...
        fun bindItem(item: LastEvent, listener: (LastEvent) -> Unit) {
        ...
        fun addToCalender(item: LastEvent?) {
